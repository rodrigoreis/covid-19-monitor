...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("FIQUE EM CASA - Todos contra o COVID-19", game.width / 2, game.height/2 - 40);
    ctx.font="16px Arial";

    ctx.fillText("Pressione 'Barra de espaço' para iniciar.", game.width / 2, game.height/2);
};
...
GameOverState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.textAlign="center";
    ctx.fillText("Fim do Jogo!", game.width / 2, game.height/2 - 40);
    ctx.font="16px Arial";
    ctx.fillText("Você marcou " + game.score + " e foi até o nível " + game.level, game.width / 2, game.height/2);
    ctx.font="16px Arial";
    ctx.fillText("Pressione 'Barra de espaço' para jogar novamente.", game.width / 2, game.height/2 + 40);
};
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.drawImage(document.getElementById("shipSkin"), this.ship.x - (this.ship.width / 2), this.ship.y - (this.ship.height / 2), this.ship.width, this.ship.height);
    ...
    for(var i=0; i<this.invaders.length; i++) {
        ...
        ctx.drawImage(document.getElementById("invaderSkin"), invader.x - invader.width/2, invader.y - invader.height/2, invader.width, invader.height);
    }
